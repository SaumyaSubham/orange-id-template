...
function LoginButton() {
  ...
  console.log("LoginButton: Auth state -", isLoggedIn ? "logged in" : (isLoggedIn === false ? "logged out" : "loading"));

  const handleOpenLogin = () => {
    console.log("LoginButton: Opening login dialog, current path:", location);
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <LoginDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} message="Sign in to access your projects and team workspaces" />
    </div>
  );
}
...
function App() {
  useEffect(() => {
    console.log("App: Initializing with environment config:", {
    ...
    <QueryClientProvider client={queryClient}>
      <OrangeAuthProvider>
        <Helmet>
          ...
          <meta
            name="description"
            content="An intelligent project management platform that streamlines developer workflows with Orange ID integration."
          />

          {/* OpenGraph Meta Tags */}
          <meta property="og:title" content="Project Management Platform" />
          <meta
          ...
          <meta property="og:site_name" content="Project Management Platform" />

          {/* Twitter Card Meta Tags */}
          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content="Project Management Platform" />
          <meta
          ...
          />
          <meta name="twitter:image:alt" content="Project Management Platform" />

          {/* Additional SEO Meta Tags */}
          <meta name="robots" content="index, follow" />
          <meta name="author" content="Project Management Platform" />
          <meta
            name="keywords"
            content="project management, developer workflows, team collaboration, Orange ID, authentication"
          />
        </Helmet>
        <Navigation />
        <Router />

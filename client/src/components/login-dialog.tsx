...
const defaultSettings = {
  ...
  title: "Sign in to Project Management",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-0 border-none bg-transparent shadow-2xl mx-auto max-w-[90vw] sm:max-w-none">
        <div className="flex flex-col relative mx-auto w-[280px] sm:w-[380px]">
          ...
          {/* Add message above login panel */}
          <div className="text-center mb-2 text-white text-sm">
            <h2 className="text-[#F37920] text-lg font-semibold">Welcome</h2>
            <p>{message}</p>
          </div>
